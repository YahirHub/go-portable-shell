...
go test -race ./...
go vet ./...
go test -run=^$ -fuzz=FuzzParserNeverPanics -fuzztime=5s
go test -run=^$ -fuzz=FuzzBraceExpansionNeverPanics -fuzztime=5s
go test -run=^$ -fuzz=FuzzQuoteProducesOneLiteralArgument -fuzztime=5s
